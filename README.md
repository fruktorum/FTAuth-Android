...
| FTLoginBtn | По нажатию запускается процесс авторизации |
| **Авторизация через сторонние аккаунты** |
| FTLoginFacebookBtn | По нажатию запускается авторизация через Facebook | 
| FTLoginGoogleBtn | По нажатию запускается авторизация через Google | 
| **Регистрация** |
| FTRegistrationBtn | По нажатию запускается процесс регистрации |
| **Выход из аккаунта** |
| FTLogoutBtn | По нажатию запускается процесс выхода из аккаунта | 
